        ...
        <div className="grid gap-6">
          ...
          <div className="card p-5">
            ...
            <div className="mt-5 grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-6">
                ...
                <div key={`${img.url}-${idx}`} className="rounded-2xl border border-[hsl(var(--border))] bg-white p-2">
                  ...
                  <div className="mt-2">
                    <Input
                      ...
                      onChange={(e) =>
                        setImages((arr) =>
                          arr.map((x, i) => (i === idx ? { ...x, sortOrder: Number(e.target.value) || 0 } : x))
                        )
                      }
                      inputMode="numeric"
                    />
              ...
              {images.length === 0 ? (
                <div className="col-span-2 text-sm text-[hsl(var(--muted))]">Sem imagens.</div>
              ) : null}
            </div>
          </div>
                ...
                <div key={idx} className="rounded-2xl border border-[hsl(var(--border))] bg-white p-4">
                  <div className="flex flex-wrap items-start justify-between gap-3">
                    ...
                    <button
                      ...
                      title={variants.length <= 1 ? "Mantenha ao menos 1 variante" : "Remover"}
                    >
                      Remover
                    </button>
                  </div>
                  ...
                  <div className="mt-4 grid gap-4 md:grid-cols-3">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setVariants((arr) =>
                            arr.map((it, i) => (i === idx ? { ...it, priceCents: Number(e.target.value) || 0 } : it))
                          )
                        }
                        inputMode="numeric"
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setVariants((arr) =>
                            arr.map((it, i) => (i === idx ? { ...it, stock: Number(e.target.value) || 0 } : it))
                          )
                        }
                        inputMode="numeric"
                      />
                    ...
                    <div className="space-y-2">
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          setVariants((arr) =>
                            arr.map((it, i) => (i === idx ? { ...it, personalization: e.target.value } : it))
                          )
                        }
                        className="w-full rounded-xl border border-[hsl(var(--border))] bg-white px-3 py-2 text-sm"
                      >
                    ...
                    <div className="space-y-2">
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          setVariants((arr) =>
                            arr.map((it, i) => (i === idx ? { ...it, isActive: e.target.value === "true" } : it))
                          )
                        }
                        className="w-full rounded-xl border border-[hsl(var(--border))] bg-white px-3 py-2 text-sm"
                      >
